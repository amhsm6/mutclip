...
func TestId(t *testing.T) {
	...
	_, _, err := s.Connect("id", ctx, make(chan net.OutMessage, 15))
	if err == nil {
...
func connect(t *testing.T, s *ClipboardServer, id ClipboardId, ctx context.Context) (chan net.InMessage, chan net.OutMessage, uuid.UUID, error, func()) {
	...
	//		case net := <-send:
	//			if net.Binary {
	//				t.Logf("%v got BIN message: %v", sid, net)
	//			} else {
	//				var a any
	//				err := json.Unmarshal(net.Data, &a)
	//				if err != nil {
	//					panic(err)
	//				}
...
func TestBasic(t *testing.T) {
	...
	recv <- net.InMessage{SID: sid2, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "hello, world"}}}}
	...
	recv <- net.InMessage{SID: sid2, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "new message"}}}}
	...
	recv <- net.InMessage{SID: sid2, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "another"}}}}
	...
	recv <- net.InMessage{SID: sid3, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "HI"}}}}
	...
	recv <- net.InMessage{SID: sid1, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "bye"}}}}
	...
	recv <- net.InMessage{SID: sid2, Message: &pb.Message{net: &pb.Message_Text{Text: &pb.Text{Data: "Oh"}}}}
